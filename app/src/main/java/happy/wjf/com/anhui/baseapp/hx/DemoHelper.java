package happy.wjf.com.anhui.baseapp.hx;
...
import happy.wjf.com.anhui.baseapp.MainActivity;
import happy.wjf.com.anhui.baseapp.R;
import happy.wjf.com.anhui.baseapp.hx.activity.ChatActivity;
import happy.wjf.com.anhui.baseapp.hx.activity.VideoCallActivity;
import happy.wjf.com.anhui.baseapp.hx.activity.VoiceCallActivity;
import happy.wjf.com.anhui.baseapp.hx.db.DemoDBManager;
import happy.wjf.com.anhui.baseapp.hx.db.InviteMessgeDao;
import happy.wjf.com.anhui.baseapp.hx.db.UserDao;
import happy.wjf.com.anhui.baseapp.hx.domain.EmojiconExampleGroupData;
import happy.wjf.com.anhui.baseapp.hx.domain.InviteMessage;
import happy.wjf.com.anhui.baseapp.hx.domain.InviteMessage.InviteMessageStatus;
import happy.wjf.com.anhui.baseapp.hx.domain.RobotUser;
import happy.wjf.com.anhui.baseapp.hx.receiver.CallReceiver;
import happy.wjf.com.anhui.baseapp.hx.utils.PreferenceManager;
import happy.wjf.com.anhui.baseapp.sqlitedb.UserApiModel;
...
public class DemoHelper {
	...
	private WJFModel wjfModel = null;
    ...
    private EMOptions initChatOptions(){
        ...
        if(wjfModel.isCustomServerEnable() && wjfModel.getRestServer() != null && wjfModel.getIMServer() != null) {
            options.setRestServer(wjfModel.getRestServer());
            options.setIMServer(wjfModel.getIMServer());
            if(wjfModel.getIMServer().contains(":")) {
                options.setIMServer(wjfModel.getIMServer().split(":")[0]);
                options.setImPort(Integer.valueOf(wjfModel.getIMServer().split(":")[1]));
            }
        }

        if (wjfModel.isCustomAppkeyEnabled() && wjfModel.getCutomAppkey() != null && !wjfModel.getCutomAppkey().isEmpty()) {
            options.setAppKey(wjfModel.getCutomAppkey());
        }
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return wjfModel.getSettingMsgSpeaker();
            }
            
            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return wjfModel.getSettingMsgVibrate();
            }
            
            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return wjfModel.getSettingMsgSound();
            }
            
            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if(message == null){
                    return wjfModel.getSettingMsgNotification();
                }
                if(!wjfModel.getSettingMsgNotification()){
                    return false;
                }else{
                    ...
                    if (message.getChatType() == ChatType.Chat) {
                        ...
                        notNotifyIds = wjfModel.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = wjfModel.getDisabledGroups();
                    }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = wjfModel.isGroupsSynced();
        isContactsSyncedWithServer = wjfModel.isContactSynced();
        isBlackListSyncedWithServer = wjfModel.isBacklistSynced();
    ...
    public Map<String, EaseUser> getContactList() {
        if (isLoggedIn() && contactList == null) {
            contactList = wjfModel.getContactList();
        }
    ...
    public void setCurrentUserName(String username){
    	...
    	wjfModel.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
    	if(username == null){
    		username = wjfModel.getCurrentUsernName();
    	}
    	return username;
    }
	...
	public Map<String, RobotUser> getRobotList() {
		if (isLoggedIn() && robotList == null) {
			robotList = wjfModel.getRobotList();
		}
		return robotList;
	}
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
         ...
         wjfModel.saveContactList(mList);
    }
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   wjfModel.setGroupsSynced(false);
                   isGroupsSyncedWithServer = false;
                   isSyncingGroupsWithServer = false;
                   noitifyGroupSyncListeners(false);
                   if(callback != null){
           ...
           public void run(){
               ...
               try {
                  ...
                  if (selfIds.size() > 0) {
                   ...
                   wjfModel.setContactSynced(true);
                   ...
                   wjfModel.setContactSynced(false);
                   isContactsSyncedWithServer = false;
                   isSyncingContactsWithServer = false;
                   notifyContactsSyncListener(false);
                   e.printStackTrace();
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   wjfModel.setBlacklistSynced(true);
                   ...
                   wjfModel.setBlacklistSynced(false);
