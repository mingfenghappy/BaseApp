package happy.wjf.com.anhui.baseapp.hx.db;
...
import happy.wjf.com.anhui.baseapp.WJFApplication;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(WJFApplication.getInstance().getApplicationContext());
    }
