package happy.wjf.com.anhui.baseapp.hx.domain;
...
public class EmojiconExampleGroupData {
    ...
    private static EaseEmojiconGroupEntity createData(){
        ...
        for(int i = 0; i < icons.length; i++){
            ...
            datas[i].setName(WJFApplication.getInstance().getApplicationContext().getString(R.string.emojicon_test_name)+ (i+1));
